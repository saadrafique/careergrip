        ...
        <div class="col-md-6">
            <div class="row" id="login">
                ...
                <div class="col-md-6" id="login-form">
                    <form class="form" method="POST" style="height: 100%" action="estore">
                        <fieldset class="form">
                            ...
                            <div class="form-group">
                                <label>HR Name</label>
                                <input type="text" class="form-control" name="username" placeholder="Last Name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="confirmation_code" placeholder="Re-Type Password" required>
                            </div>
